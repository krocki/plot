...
* @Last Modified time: 2017-02-28 21:04:09
*/
...
public:
	...
	virtual void draw ( NVGcontext *ctx ) {
		...
		char str[16];
		int last_avg = 10;
		sprintf ( str, "%.1f\n", graphDyn->values().block( HISTORY_SIZE - 1 - last_avg, 0, last_avg, 1).mean() / fps_scale );
		...
		drawParagraph ( ctx, log_str, 450, 50, 150, 100, mx, my );
	}
